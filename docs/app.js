...
if ("serviceWorker" in navigator) {
  navigator.serviceWorker
    .register("/lookup-stock/app-worker.js")
    .then(reg => {
...
// Env
// -----------------------------------------------------------------------------
const goappEnv = {"GOAPP_INTERNAL_URLS":"null","GOAPP_ROOT_PREFIX":"/lookup-stock","GOAPP_STATIC_RESOURCES_URL":"/lookup-stock","GOAPP_VERSION":"d6e60dcae5f665b803c637c7aa8bbedb98e6afd7"};
...
if (!/bot|googlebot|crawler|spider|robot|crawling/i.test(navigator.userAgent)) {
  ...
  WebAssembly.instantiateStreaming(fetch("/lookup-stock/web/app.wasm"), go.importObject)
    .then(result => {
